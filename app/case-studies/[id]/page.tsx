        ...
        <main className="min-h-screen bg-background selection:bg-accent/20 selection:text-accent w-full">
                    ...
                    <motion.div variants={containerVariants} initial="hidden" animate="visible">
                        ...
                        <motion.div variants={itemVariants} className="flex flex-col gap-6">
                            ...
                            <div className="flex flex-wrap gap-4 items-center">
                                <div>
                                    <p className="text-xs text-muted-foreground uppercase tracking-wider font-medium mb-1">Key Result</p>
                                    <p className="text-2xl font-semibold text-accent">{caseStudy.keyResult}</p>
                                </div>
                                <div className="h-10 w-px bg-border"></div>
                                <div>
                                    <p className="text-xs text-muted-foreground uppercase tracking-wider font-medium mb-1">Timeline</p>
                                    <p className="text-lg font-medium text-foreground">{caseStudy.timeline}</p>
                                </div>
                            </div>
            ...
            <section className="px-6 bg-background">
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        ...
                        <div className="absolute left-[22px] top-0 bottom-0 w-0.5 bg-border/30" style={{ top: "32px" }}>
                            <motion.div
                        ...
                        <motion.div variants={itemVariants}>
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h2 className="text-2xl font-medium text-foreground mb-3">The Challenge</h2>
                        ...
                        <motion.div variants={itemVariants}>
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h2 className="text-2xl font-medium text-foreground mb-3">Our Solution</h2>
                        ...
                        <motion.div variants={itemVariants}>
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1">
                                    <h2 className="text-2xl font-medium text-foreground mb-4">Results & Impact</h2>
                                    <ul className="space-y-3">
                                        {caseStudy.results.map((result, index) => (
                                            <li key={index} className="flex gap-3 text-lg text-muted-foreground">
            ...
            {caseStudy.testimonial && (
                <section className="py-20 px-6 bg-background">
                    <div className="max-w-4xl mx-auto">
                        <div
                            className="bg-accent/5 border border-accent/10 p-8 md:p-12 rounded-2xl relative overflow-hidden"
                        >
                            <FadeIn margin="-100px">
