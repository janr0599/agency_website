...
import { ArrowRight, Search, Cog, CheckCircle, MoreHorizontal } from "lucide-react"
            ...
            <main>
                    ...
                    <div className="max-w-5xl mx-auto text-center relative z-10">
                        <FadeIn>
                            ...
                            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed mb-10">
                                Bridge the gap between your Practice Management System and your favorite productivity tools. Your
                                integrations run on your n8n account for complete control and security.
                            </p>
                        </FadeIn>
                    </div>
                </section>
                ...
                <section className="px-6 max-w-7xl mx-auto pt-12 mb-24">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
                        {integrationCategories.map((category, index) => {
                            ...
                            return (
                                ...
                                >
                                    <p className={`text-sm font-medium ${isSelected ? "text-teal-700" : "text-[#0f172a]"}`}>
                                        {category.label}
                                    </p>
                                </motion.button>
                            )
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredIntegrations.slice(0, 5).map((integration, index) => (
                            <motion.div
                            ...
                            >
                                ...
                                <h3 className="text-xl font-medium text-[#0f172a] mb-2">{integration.name}</h3>
                        ...
                        >
                            <div>
                                ...
                                <h3 className="text-xl font-medium text-[#0f172a] mb-2">+1,000 Enterprise Connectors</h3>
                                <p className="text-sm text-slate-600 mb-4 leading-relaxed">
                                    If your software has an API, we can automate it. We specialize in connecting niche legal legacy
                                    systems with modern cloud infrastructure.
                                </p>
                            </div>
                        </motion.div>
                    </div>
                ...
                <section className="px-6 max-w-7xl mx-auto mb-24">
                    ...
                    >
                        <h2 className="text-3xl md:text-4xl font-medium mb-12 text-center">How We Build Integrations</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="space-y-4">
                                ...
                                <p className="text-slate-300 leading-relaxed">
                                    We analyze your Legal Practice Management Systems and tech stack to identify integration opportunities
                                    that will save the most time for your team.
                                </p>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <h3 className="text-xl font-medium">Custom Build</h3>
                                <p className="text-slate-300 leading-relaxed">
                                    We configure enterprise-grade n8n workflows that prioritize data security and zero-loss transfers.
                                    Your integrations run on your n8n account for complete control.
                                </p>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-slate-300 leading-relaxed">
                                    We maintain and scale your integrations as your firm grows and your tools evolve, ensuring your
                                    automations remain reliable and effective.
                                </p>
                            </div>
                        </div>
                    </motion.div>
                ...
                <section className="px-6 max-w-7xl mx-auto text-center mb-24">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h2 className="text-3xl md:text-4xl font-medium text-[#0f172a] mb-6">Ready to automate your tech stack?</h2>
                        <p className="text-slate-500 max-w-xl mx-auto mb-8 text-lg">
                            Let's talk about which integrations will have the most impact on your firm.
                        </p>
