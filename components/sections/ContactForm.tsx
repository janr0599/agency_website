        ...
        return (
            <div className="text-center py-12 space-y-4">
                ...
                <p className="text-muted-foreground">
                    Thank you for reaching out. We'll get back to you shortly to schedule your workflow audit.
                </p>
                <button
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        className={cn(
                            ...
                            touched.name && errors.name ? "border-red-500 focus:ring-red-500/20" : "border-input focus:ring-ring"
                        )}
                    />
                ...
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        className={cn(
                            "w-full px-4 py-3 bg-background border rounded-lg text-foreground focus:outline-none focus:ring-2 disabled:opacity-50 transition-colors",
                            touched.email && errors.email ? "border-red-500 focus:ring-red-500/20" : "border-input focus:ring-ring"
                        )}
                    />
            ...
            <div className="space-y-2">
                ...
                <input
                    ...
                    className={cn(
                        "w-full px-4 py-3 bg-background border rounded-lg text-foreground focus:outline-none focus:ring-2 disabled:opacity-50 transition-colors",
                        touched.firm && errors.firm ? "border-red-500 focus:ring-red-500/20" : "border-input focus:ring-ring"
                    )}
                />
            ...
            <div className="space-y-2">
                ...
                <textarea
                    ...
                    className={cn(
                        "w-full px-4 py-3 bg-background border rounded-lg text-foreground focus:outline-none focus:ring-2 disabled:opacity-50 transition-colors",
                        touched.message && errors.message ? "border-red-500 focus:ring-red-500/20" : "border-input focus:ring-ring"
                    )}
                />
